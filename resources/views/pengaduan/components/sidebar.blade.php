            ...
            <li>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="flex flex-col w-full -space-y-1">
                        <p class="text-lg text-white font-semibold">Pengaduan Desa Wonorejo</p>
                    </div>
            </li>

            <li>
                <a href="/pengaduan/admin/stats"
                    ...
                    <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-black dark:group-hover:text-white"
                        ...
                        <path d="M3 17h3v4H3v-4zm6-8h3v12H9V9zm6-5h3v17h-3V4zm6 10h3v7h-3v-7z" />
                    </svg>
