...
<div class="flex justify-between items-center mb-6">
    ...
    <!-- Formulir pencarian -->
    <form class="flex items-center max-w-lg w-full" action="{{ url('posyandu/remaja') }}" method="GET">
        ...
        <tbody>
            @foreach($remajas as $index => $remaja)
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        {{ \Carbon\Carbon::parse($remaja->tanggal)->translatedFormat('d F Y') }}
                    </td>
                    <td class="px-6 py-4">
                        {{ $remaja->keterangan_lain }}
                    </td>
                    <td class="px-1 py-4">
                        <a href="{{ url('posyandu/remaja/edit', ['id' => $remaja->id]) }}" class="font-medium bg-blue-200 px-5 py-2 hover:bg-blue-300 rounded-lg text-blue-600 dark:text-blue-500">
                            Edit
                        </a>
                    </td>
                    ...
                    <td class="px-1 py-4">
                        ...
                        <button 
                            ...
                            data-url="{{ url('posyandu/remaja/delete', $remaja->id) }}" 
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Anda yakin untuk menghapus data remaja?</h3>
