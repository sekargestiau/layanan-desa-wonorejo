  ...
  <form action="{{ url('posyandu/remaja/update/' . $remaja->id) }}" method="POST">
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <div class="flex items-center">
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="berat_badan" id="berat_badan" type="number" value="{{ $remaja->berat_badan }}">
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <div class="flex items-center">
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="tinggi_badan" id="tinggi_badan" type="number" value="{{ $remaja->tinggi_badan }}">
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
                ...
                <div class="flex items-center">
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="tensi_darah_sistolik" id="tensi_darah_sistolik" type="number" value="{{ $remaja->tensi_darah_sistolik }}">
            ...
            <div>
                ...
                <div class="flex items-center">
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="tensi_darah_diastolik" id="tensi_darah_diastolik" type="number" value="{{ $remaja->tensi_darah_diastolik }}">
