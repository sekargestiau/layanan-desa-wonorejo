  ...
  <form action="{{ url('posyandu/remaja/update/' . $remaja->id) }}" method="POST">
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <div class="flex items-center">
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="tensi_darah" id="tensi_darah" type="number" value="{{ $remaja->tensi_darah }}">
